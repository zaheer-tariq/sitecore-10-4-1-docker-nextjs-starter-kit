  ...
  try {
    ...
    try {
      jss setup `
        ...
        --layoutServiceHost "https://cm.basiccompany.localhost" `
        --apiKey "33F0902D-05E2-4298-8A84-8A25BFF79202" `
        --deployUrl "https://cm.basiccompany.localhost/sitecore/api/jss/import" `
        --deploySecret "8D2B7E05B5C14323ADC04A7265CE6A2C" `
        --nonInteractive `
